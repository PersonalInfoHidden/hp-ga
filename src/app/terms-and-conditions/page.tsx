export default function Page() {
    return (
        <div>
            <p>
                När du registrerar ett konto ger du oss tillåtelse att lagra din
                data, bland annat email-address och lösenord, i molntjänsten
                Supabase för att tillhandahålla tjänsten, och att vi skickar
                email med formulär för utvärdering eller för uppdateringar i
                våra villkor. <br />
